package eu.se_bastiaan.tvnl.exomedia.okhttp;
...
public final class OkUriDataSource implements UriDataSource {
     ...
     */
    private OkUriDataSource(@NonNull Context context, TransferListener listener, @NonNull UriDataSource httpDataSource) {
